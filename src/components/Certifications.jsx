...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="section-padding bg-gradient-to-b from-dark-base via-dark-forest/20 to-dark-base relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          className="card-premium-hover p-12 text-center"
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.2 }}
